...
Each case includes domain schema and entity mapping for NL→DSL conversion
"""
...
def save_test_cases():
    ...
    # Count how many have domain schema
    with_schema = sum(1 for tc in TEST_CASES if 'domain_schema' in tc)
    print(f"  With Domain Schema: {with_schema}/{len(TEST_CASES)}")
